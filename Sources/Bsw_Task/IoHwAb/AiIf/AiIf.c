...
GeneralReturnType AiIf_MeasureChannel(uByte AiIf_ChannelId,uWord *AiIf_AdValuePtr)
{
  ...
  // const sAiIf_PropertyType *AiIf_PropPtr;
   ...
   if(AiIf_ChannelId < 15)  //channel0~channel14---AI1
   {
   ...
   else if((AiIf_ChannelId >= 15) && (AiIf_ChannelId <= 16))   //channel15~channel16 AI2
   {
       Ai_rslt = AI2_Enable(); //enable ad measure
    	 ...
    	 Ai_rslt = AI2_MeasureChanWait(AiIf_ChannelId - 15);  //start ad and measure
    	 if(Ai_rslt != ERR_OK) 
    	 {
    	     return (GeneralReturnType)Ai_rslt;
    	 }
    	 Ai_rslt = AI2_GetChanValue((AiIf_ChannelId - 15),AiIf_AdValuePtr); //read ad value
    	 if(Ai_rslt != ERR_OK) 
    	 {
    	     return (GeneralReturnType)Ai_rslt;
    	 }
