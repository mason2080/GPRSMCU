...
/*Read GPRS*/
extern void RD_GPRSSysconfProductNo(void)  ;
extern void RD_GPRSCfgVer(void);
extern void RD_GPRSCodeInfo(void);
extern void RD_GPRSVehiclePlate(void);
extern void RD_GPRSSoh(void);
