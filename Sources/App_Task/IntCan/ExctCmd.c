...
void WR_BCUTemperStartNo(void)
{
    ...
    //BMU1- BMU15 start temper no  30byte
    gby_rslt[0] = EE_LoadVar(SYSCONF_BMU_START_TEMPERNO_G1);
    CanTpMsgTx.Data[1] = GET_HIGH_BYTE(gby_rslt[0]);
    CanTpMsgTx.Data[2] = GET_LOW_BYTE(gby_rslt[0]);
    /* if(ERR_OK != gby_rslt[0])
    ...
    gby_rslt[0] = SysConf_GetParaValueFromRam(SYSCONF_BMU_START_TEMPERNO_G1, gby_data,&gby_length);
    CanTpMsgTx.Data[1] = GET_HIGH_BYTE(gby_rslt[0]);
    CanTpMsgTx.Data[2] = GET_LOW_BYTE(gby_rslt[0]);
    if(ERR_OK != gby_rslt[1])
    {
    ...
    gby_rslt[0] =  SysConf_UpdataParaToRam(SYSCONF_BMU_START_TEMPERNO_G1, gby_data_bak);
    CanTpMsgTx.Data[1] = GET_HIGH_BYTE(gby_rslt[0]);
    CanTpMsgTx.Data[2] = GET_LOW_BYTE(gby_rslt[0]);
    if(ERR_OK != gby_rslt[0])
    {
    ...
    gby_rslt[0] =  EE_SaveVarForCalib(BOTHEE, SYSCONF_BMU_START_TEMPERNO_G1);
    CanTpMsgTx.Data[1] = GET_HIGH_BYTE(gby_rslt[0]);
    CanTpMsgTx.Data[2] = GET_LOW_BYTE(gby_rslt[0]);
    if(ERR_OK != gby_rslt[2])
    {
    ...
    //BMU16- BMU30 start temper no
    gby_rslt[0] = EE_LoadVar(SYSCONF_BMU_START_TEMPERNO_G2);
    CanTpMsgTx.Data[1] = GET_HIGH_BYTE(gby_rslt[0]);
    CanTpMsgTx.Data[2] = GET_LOW_BYTE(gby_rslt[0]);
    /* if(ERR_OK != gby_rslt[0])
    ...
    gby_rslt[0] = SysConf_GetParaValueFromRam(SYSCONF_BMU_START_TEMPERNO_G2, gby_data,&gby_length);
    CanTpMsgTx.Data[1] = GET_HIGH_BYTE(gby_rslt[0]);
    CanTpMsgTx.Data[2] = GET_LOW_BYTE(gby_rslt[0]);
    if(ERR_OK != gby_rslt[1])
    {
    ...
    gby_rslt[0] =  SysConf_UpdataParaToRam(SYSCONF_BMU_START_TEMPERNO_G2, gby_data_bak);
    CanTpMsgTx.Data[1] = GET_HIGH_BYTE(gby_rslt[0]);
    CanTpMsgTx.Data[2] = GET_LOW_BYTE(gby_rslt[0]);
    if(ERR_OK != gby_rslt[0])
    {
    ...
    gby_rslt[0] =  EE_SaveVarForCalib(BOTHEE, SYSCONF_BMU_START_TEMPERNO_G2);
    CanTpMsgTx.Data[1] = GET_HIGH_BYTE(gby_rslt[0]);
    CanTpMsgTx.Data[2] = GET_LOW_BYTE(gby_rslt[0]);
...
void WR_BCUFusePos(void)
{
    //BMU0 FUSE position
    CanTpMsgTx.Data[0] = CanTpMsgRx.Data[0];
    gby_rslt[0] = EE_LoadVar(SYSCONF_BMU0_FUSE_POS);
    CanTpMsgTx.Data[1] = GET_HIGH_BYTE(gby_rslt[0]);
    CanTpMsgTx.Data[2] = GET_LOW_BYTE(gby_rslt[0]);
    /* if(ERR_OK != gby_rslt[0])
    ...
    gby_rslt[0] = SysConf_GetParaValueFromRam(SYSCONF_BMU0_FUSE_POS, gby_data,&gby_length);
    CanTpMsgTx.Data[1] = GET_HIGH_BYTE(gby_rslt[0]);
    CanTpMsgTx.Data[2] = GET_LOW_BYTE(gby_rslt[0]);
    if(ERR_OK != gby_rslt[0])
    {
    ...
    gby_rslt[0] =  SysConf_UpdataParaToRam(SYSCONF_BMU0_FUSE_POS, gby_data_bak);
    CanTpMsgTx.Data[1] = GET_HIGH_BYTE(gby_rslt[0]);
    CanTpMsgTx.Data[2] = GET_LOW_BYTE(gby_rslt[0]);
    if(ERR_OK != gby_rslt[0])
    {
    ...
    gby_rslt[0] =  EE_SaveVarForCalib(BOTHEE, SYSCONF_BMU0_FUSE_POS);
    CanTpMsgTx.Data[1] = GET_HIGH_BYTE(gby_rslt[0]);
    CanTpMsgTx.Data[2] = GET_LOW_BYTE(gby_rslt[0]);
    ECU_DELAYMS(6);
    CanTpMsgTx.DataLen = 3;
...
void RD_BCUTemperStartNo(void)
{
    ...
    if(ERR_OK == gby_rslt[0])
    {
        gby_rslt[1] =  SysConf_GetParaValueFromRam(SYSCONF_BMU_START_TEMPERNO_G1, gby_data,&gby_length);
        if(ERR_OK == gby_rslt[1])
        {
    ...
    if(ERR_OK == gby_rslt[0])
    {
        gby_rslt[1] =  SysConf_GetParaValueFromRam(SYSCONF_BMU_START_TEMPERNO_G2, gby_data,&gby_length);
        if(ERR_OK == gby_rslt[1])
        {
            CanTpMsgTx.Data[1] = GET_HIGH_BYTE(gby_rslt[1]);
            CanTpMsgTx.Data[2] = GET_LOW_BYTE(gby_rslt[1]);
...
void RD_GPRSCfgVer(void)
{
    ...
    if(ERR_OK == gby_rslt[0])
    {
        ...
        if(ERR_OK == gby_rslt[1])
        {
            for(gby_i = 0; gby_i  < 5; gby_i++)
            {
                PORT[gby_i] = gby_data[gby_i];
            }
        }
    }
...
void RD_GPRSSoh(void)
{
    ...
    if(ERR_OK == gby_rslt[0])
    {
        ...
        if(ERR_OK == gby_rslt[1])
        {
            for(gby_i = 0; gby_i  < 1; gby_i++)
            {
               PlatForm = gby_data[gby_i];
            }
        }
...
void RD_BCUFusePos(void)
{
    ...
    if(ERR_OK == gby_rslt[0])
    {
        gby_rslt[1] =  SysConf_GetParaValueFromRam(SYSCONF_BMU0_FUSE_POS, gby_data,&gby_length);
        if(ERR_OK == gby_rslt[1])
        {
            CanTpMsgTx.Data[1] = GET_HIGH_BYTE(gby_rslt[1]);
            CanTpMsgTx.Data[2] = GET_LOW_BYTE(gby_rslt[1]);
...
void RD_GPRSCodeInfo(void)
{
    ...
    if(ERR_OK == gby_rslt[0])
    {
        ...
        if(ERR_OK == gby_rslt[1])
        {
            ...
            for(gby_i = 0; gby_i  < 8; gby_i++)
            {
                CARNUM[gby_i] = gby_data[gby_i];
            }
            
            for(gby_i = 8; gby_i  < 21; gby_i++)
            {
                VIN[gby_i-8] = gby_data[gby_i];
            }
        }
    }
}
