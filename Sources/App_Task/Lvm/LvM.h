...
#define LVM_STATE_ON_THRED     60 //6V
#define LVM_STATE_OFF_THRED    50 //5V
...
#define POWER_OFF()  (DoIf_Ctrl((uByte)DOIF_CON_NO, (bool)DOIF_CMD_HIGH))
#define POWER_ON()  (DoIf_Ctrl((uByte)DOIF_CON_NO, (bool)DOIF_CMD_LOW))
